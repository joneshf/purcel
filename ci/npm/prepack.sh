...
LINUX_URL="${BASE_URL}/purcel-${VERSION}-linux.tar.gz"
OSX_URL="${BASE_URL}/purcel-${VERSION}-osx.tar.gz"
...
mv "${TEMPORARY_DIR}/purcel" "bin/linux/purcel"
...
mv "${TEMPORARY_DIR}/purcel" "bin/osx/purcel"
